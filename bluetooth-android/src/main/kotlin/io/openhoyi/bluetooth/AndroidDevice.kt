...
class AndroidDevice(context:Context,role:DeviceRole,stateChanged:(DeviceState)->Unit={},
    ...
    val session:DeviceSession=DeviceSession(role,driver,{SystemClock.elapsedRealtime()},stateChanged,coffeeFrame,weightFrame,diagnostic,legacyVerifiedStartFrames)
