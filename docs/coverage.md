...
Alpha 日常版第一段功能见[说明](mobile-alpha.md)。工厂曲线会话门禁与独立去皮接入后，会话检查34项、Alpha单测22项通过，debug构建成功，Lint 0错误、2条警告。当前用户要求暂不安装，尚无Alpha实机萃取或独立去皮证据。Lab独占连接约6分钟、后台/锁屏各约1分钟持续收数，见上方报告。
