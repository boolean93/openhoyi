...
Alpha 日常版第一段功能见[说明](mobile-alpha.md)。累计杯数重置接入后，协议检查36,796项、会话检查36项、Alpha单测53项通过，debug构建成功，Lint 0错误、2条警告。当前用户要求暂不安装，尚无Alpha实机萃取、槽位启停、独立去皮、睡眠、睡眠计划写入、设置回读或告警证据。Lab独占连接约6分钟、后台/锁屏各约1分钟持续收数，见上方报告。
